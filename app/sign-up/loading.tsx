    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="text-center space-y-6">
        ...
        <div className="space-y-2">
          <p className="text-white text-lg font-medium">Starting your adventure</p>
          <p className="text-gray-400 text-sm">Creating your traveler account</p>
        </div>

        {/* Sign-up icon */}
        <div className="flex justify-center">
          <UserPlus className="w-6 h-6 text-green-400 animate-pulse" />
        </div>
      </div>
    </div>
  )
